     ...
     <div className="hidden xl:block absolute bottom-1/4 right-[5%] animate-float-slow opacity-10">
      ...
      <div className="flex justify-center mb-12">
       ...
       <div className="grid lg:grid-cols-2 gap-6">
         ...
         {/* Active Service Content - Right Side - Updated to match AboutCard style */}
         <div className="order-1 lg:order-2">
           {activeServiceData && (
             <div
               key={activeService}
               className="rounded-[48px] p-2.5 bg-gradient-to-br from-blue-100 via-blue-50 to-amber-50 backdrop-blur-sm shadow-lg"
